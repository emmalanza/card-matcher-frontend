...
const InfoSection = () => {
    return (
        ...
        bg-gradient-to-b from-[#2649ad] to-[#326bbb] bg-center h-screen">
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl text-center text-third font-bold">
                Encuentra tu <strong>MATCH</strong>
            </h2>

            <img src={Separator} className="w-full lg:w-2/3" alt="Line" />

            <h3 className="text-white textl-lg md:text-2xl lg:text-3xl text-center font-bold">Si juegas TCG Pokect y quieres conseguir esas cartas que te faltan,
                <strong> CardMatchr</strong>  es la app perfecta para ti.</h3>

            <ul className="text-white text-xs md:text-md lg:text-lg xl:text-xl 2xl:text-2xl
            space-y-4 max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl">
                <li className="flex items-start space-x-6">
                    <img src={XMark} alt="X" className="w-2 h-2 md:w-4 md:h-4 mt-1" />
                    <span>
